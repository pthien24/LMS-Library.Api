...
namespace LMS_Library.Api.Data.Migrations
{
    ...
    [Migration("20240403085740_InittialEnroll")]
    partial class InittialEnroll
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FLMS_Library.Api.Data.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FLMS_Library.Api.Data.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
